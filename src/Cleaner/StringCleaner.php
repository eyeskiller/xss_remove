...
/**
 * String cleaner for removing XSS and SQLi from strings.
 *
 * @version    2.0.0
 */
class StringCleaner extends AbstractCleaner
{
    /**
    ...
    public function clean(string $data): string
    {
        ...
        // Additional modern sanitization
